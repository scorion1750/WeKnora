export default {
  ...
  business: {
    home: {
      ...
      title: 'Nuclear knowledge & research collaboration',
      desc: 'Documents, research projects, and integrations live here. Enter RAG when you need retrieval and Q&A.',
      enterRag: 'Enter RAG',
      bizOnline: 'Biz service online',
      bizOffline: 'Biz service offline',
      phaseTitle: 'Phase-1 completion (1A + 2A skeleton)',
      phaseDesc: 'Checked items are delivered. Unchecked items are out of scope for this phase.',
      phase: {
        skeleton: 'Biz microservice & DB',
        skeletonDesc: 'FastAPI + rag_biz + JWT validate + Vite /biz/api proxy',
        office: 'Documents',
        officeDesc: 'Upload, preview, one-click KB ingest; CATIA metadata placeholder only',
        project: 'Research projects',
        projectDesc: 'Project/task CRUD, template plan generation, Gantt',
        integration: 'Integrations',
        integrationDesc: 'Connector CRUD, HTTP probe, sync job logs',
        later: 'Later phases (not done)',
        laterDesc: 'WPS editing, real CATIA conversion, on-prem adapters, Dameng cutover, egress policy page',
      },
    },
    modules: {
      office: {
        title: 'Documents',
        desc: 'Word, PDF, images, and lightweight CATIA models for authoring and ingest.',
      },
      project: {
        title: 'Research projects',
        desc: 'National project applications, Gantt plans, tasks, and progress.',
      },
      integration: {
        title: 'Integrations',
        desc: 'Pull data from other on-prem systems into the business and knowledge stores.',
      },
      rag: {
        title: 'RAG',
        desc: 'Knowledge bases, chat, agents, and artifacts.',
      },
    },
    common: {
      delete: 'Delete',
      ...
      actions: 'Actions',
      retry: 'Retry',
      serviceDown: 'Business service unavailable (default http://127.0.0.1:8090). Start biz-service and retry.',
    },
    menuSettings: {
      title: 'Business menus',
      description: 'Control which business entries appear in the sidebar. Integrations are off by default.',
      save: 'Save',
      reset: 'Reset',
      adminOnly: 'Only workspace admins can change business menus.',
      atLeastOne: 'Enable at least one business menu',
      items: {
        home: 'Workbench',
        homeDesc: 'Business home and module shortcuts',
        office: 'Documents',
        officeDesc: 'Upload, preview, CAD lightweight view, KB ingest',
        project: 'Projects',
        projectDesc: 'Projects, tasks, and Gantt plans',
        integration: 'Integrations',
        integrationDesc: 'Connectors and sync jobs (off by default)',
      },
    },
    project: {
      create: 'New project',
      ...
      generatePlan: 'Generate plan draft',
      generatePlanDisabled: 'Tasks already exist; plan draft is disabled',
      viewGantt: 'View Gantt',
      addTask: 'Add task',
      editTask: 'Edit task',
      deleteProject: 'Delete project',
      deleteProjectConfirm: 'Delete this project and its tasks?',
      deleteTaskConfirm: 'Delete this task?',
      tasks: 'Tasks',
      tasksEmpty: 'No tasks yet. Add a task or generate a plan draft.',
      gantt: 'Gantt',
      ganttEmpty: 'No schedule bars. Set task dates or generate a plan draft.',
      planGenerated: 'Plan draft generated',
      name: 'Name',
      code: 'Code',
      description: 'Description',
      taskTitle: 'Task title',
      assignee: 'Assignee',
      assigneePlaceholder: 'Select a workspace member',
      schedule: 'Schedule',
      status: 'Status',
      progress: 'Progress',
      start: 'Start',
      ...
      collapseSide: 'Collapse project list',
      expandSide: 'Expand project list',
    },
    office: {
      upload: 'Upload',
      empty: 'No documents yet',
      selectHint: 'Select a document to preview',
      searchPlaceholder: 'Search title / file name / category',
      preview: 'Preview',
      ...
      colCreated: 'Uploaded',
      ingest: 'Ingest to KB',
      ingestConfirm: 'Confirm ingest',
      ingestSuccess: 'Ingested into knowledge base',
      kb: 'Knowledge base',
      kbPlaceholder: 'Select knowledge base',
      cadPlaceholder: 'No lightweight preview yet — try Convert again',
      cadConverting: 'Converting to lightweight model…',
      cadConvert: 'Convert',
      cadPreviewFailed: 'Failed to load CAD preview',
    },
    integration: {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and RAG parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this RAG host; scripts and files stay in that container',
      },
      ...
      dockerHostRisk: 'Empty or unix:// uses the Docker daemon on the RAG host, which is equivalent to root on that machine. Use this only for a private single-node install. Prefer Cube or E2B when multiple workspaces share a host. Remote tcp:// endpoints require a TLS certificate directory.',
      ...
      weknoraTemplateTitle: 'RAG standard template',
      weknoraDockerImage: 'RAG standard image',
      ...
      weknoraTemplateOverview: 'RAG provides the standard runtime. Templates are discovered after connecting and the standard one is created when missing.',
      weknoraTemplateDescription: 'Includes the Python, Node.js, CLI tools, workspace path, and non-root execution user expected by RAG skills.',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. Missing RAG CLI templates are built from the official Hub image. Desktop templates are larger; create them from the row below. After changing DNS or the image, rebuild from that card.',
      templateLoadFailed: 'Failed to load templates',
      standardTemplateProvisioning: 'The RAG standard template is being created. Refresh shortly to see its status.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; RAG will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'RAG standard template',
      ...
      weknoraDesktopTemplate: 'RAG desktop template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the RAG standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
      desktopTemplateProvisioning: 'The RAG desktop template is being created. Refresh shortly to see its status.',
      ...
      replaceDesktopTemplateConfirm: 'Rebuild the RAG desktop template with the current settings, including DNS. The previous spawnable desktop template is not deleted until the replacement is ready. The CLI template is left untouched.',
      ...
      dockerTlsCertPathHelp: 'Directory on the RAG host holding ca.pem, cert.pem and key.pem. Required for a remote daemon; certificates are mounted by the deployment, never stored here.',
      dockerIdleTtl: 'Idle reclaim (seconds)',
      dockerIdleTtlHelp: 'The Docker daemon has no idle timeout of its own. A container that runs no command for this long is reclaimed by RAG and rebuilt when the session continues. Empty means 1800 seconds.',
    ...
    weknoraCloud: {
      title: 'RAG Cloud',
      description: 'Configure RAG Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'RAG Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'RAG Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'RAG Cloud application secret',
      ...
      credentialConfigured: 'RAG Cloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'RAG Cloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'RAG Cloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard RAG Cloud models for chat, retrieval, reranking, and vision.',
      ...
      addModelsDisplayName: {
        chat: 'RAG Cloud Chat',
        embedding: 'RAG Cloud Embedding',
        rerank: 'RAG Cloud ReRank',
        vllm: 'RAG Cloud Vision'
      }
    },
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not RAG system or deployment settings.',
  ...
  createChat: {
    title: 'Hi, I am RAG — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    originsHint: 'Enter the host websites allowed to embed this channel (A), not the RAG address (B). One full origin per line, e.g. https://shop.example.com; at least one required. Supports *.example.com.',
    ...
    webhookUrlDesc: 'Optional. RAG POSTs message_sent / message_received events to this HTTPS endpoint.',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'RAG Cloud',
          desc: 'Document parsing via RAG Cloud'
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and RAG Cloud credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in RAG; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted RAG: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On RAG Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'RAG Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the RAG REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install RAG Skill · opens in a new tab',
